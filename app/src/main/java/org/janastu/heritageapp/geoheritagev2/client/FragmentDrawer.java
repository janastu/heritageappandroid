...
public class FragmentDrawer extends Fragment {
    ...
    public   List<NavDrawerItem> getData() {
        ...
        for (int i = 0; i < heritageCategoriesStringList.size(); i++) {
            NavDrawerItem navItem = new NavDrawerItem();
            navItem.setTitle(heritageCategoriesStringList.get(i));
            //setchecked
            data.add(navItem);
        }
        return data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.material_fragment_navigation_drawer, container, false);
